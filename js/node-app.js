...
//params
var fileTypeJson = false;
var fontFilePath = process.argv[2];
var reverseTypeface = false;

var buffer = fs.readFileSync(fontFilePath);
var arrayBuffer = new Uint8Array(buffer).buffer;
var font = opentype.parse(arrayBuffer);

var outputFileName = font.familyName + "_" + font.styleName + ( fileTypeJson ? ".json" : ".js" );
